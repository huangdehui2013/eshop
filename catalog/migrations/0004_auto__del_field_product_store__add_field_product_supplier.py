...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('catalog_product', 'store')

        # Adding field 'Product.supplier'
        db.add_column('catalog_product', 'supplier',
                      self.gf('django.db.models.fields.CharField')(default='hewlett Packard', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.store'
        db.add_column('catalog_product', 'store',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Product.supplier'
        db.delete_column('catalog_product', 'supplier')
    ...
    models = {
        ...
        'catalog.product': {
            ...
            'supplier': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
