...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.store2'
        db.add_column('catalog_product', 'store2',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.store2'
        db.delete_column('catalog_product', 'store2')
    ...
    models = {
        ...
        'catalog.product': {
            ...
            'store2': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
